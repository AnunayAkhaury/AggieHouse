  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('/Users/sanjith/Personal/Development/VSCodeProjects/aggieHouse/AggieHouse/AggieHouse/frontend/assets/feedback.png')}
          style={styles.image}
        />
      </View>
