    ...
    <View style={tw`flex-1 bg-gray-100`}>
      ...
      <SafeAreaView style={tw`flex-1 relative`}>
        <Image
          ...
          style={tw`absolute top-0 w-full h-33 opacity-60`}
        />
        ...
        <View style={tw`w-full px-3`}>
          ...
          <Text style={tw`text-[1.5rem] font-medium text-center -10 mt-4`}>
            Admin Dashboard
          </Text>

          <Text style={tw`text-xl font-semibold text-center mt-1`}>
            Daily Volunteer Hours for {selectedVolunteer}
          </Text>
          ...
          <Text style={tw`text-xl font-semibold text-center mt-4`}>
            Weekly Volunteer Hours for {selectedVolunteer}
          </Text>
